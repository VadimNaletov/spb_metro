...
public class Main {
    ...
    private static Logger loggerInputError;
    ...
    public static void main(String[] args) {
        ...
        loggerSearch = LogManager.getRootLogger();
        System.out.println("Программа расчёта маршрутов метрополитена Санкт-Петербурга\n");
        scanner = new Scanner(System.in);
        for (; ; ) {
            Station from = takeStation("Введите станцию отправления:");
            loggerSearch.info("Станция " + from + " сущетсвует");
            Station to = takeStation("Введите станцию назначения:");
            loggerSearch.info("Станция " + to + " существует");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                ...
                loggerInputError = LogManager.getRootLogger();
                loggerInputError.error("Станции " + line + " не существет");
            }
    ...
    private static void createStationIndex() {
        ...
        try {
            ...
            loggerException = LogManager.getRootLogger();
            loggerException.debug(ex.getMessage());
            ex.printStackTrace();
        }
    }
